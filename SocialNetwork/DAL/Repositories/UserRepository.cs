...
namespace SocialNetwork.DAL.Repositories
{
    public class UserRepository : BaseRepository, IUserRepository
    {
        ...
        {
            var ret = Execute(@"insert into users (firstname,lastname,password,email) 
        ...
        {
            var ret = Execute(@"update users set firstname = :firstname, lastname = :lastname, password = :password, email = :email,
